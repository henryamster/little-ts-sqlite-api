...
import { CLEAR_DATABASE, DROP_AND_CREATE_DATABASE } from "../config";
...
export function addModels() {
  LogEvent.fromString(
    `Looking for models in ${path.resolve(__dirname, ".././models")}`
  );
  ...
  DROP_AND_CREATE_DATABASE
    ? dbInstance.dropAndCreateDatabase()
    : dbInstance.initializeDbContext();
